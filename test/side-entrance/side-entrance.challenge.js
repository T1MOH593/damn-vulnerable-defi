...
describe('[Challenge] Side entrance', function () {
    ...
    it('Exploit', async function () {
        const AttackerFactory = await ethers.getContractFactory('SideEntranceAttacker', attacker);
        const sideEntrance = await AttackerFactory.deploy(this.pool.address)
        const sideEntranceAttacker = sideEntrance.connect(attacker)
